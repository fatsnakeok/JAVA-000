...
import io.github.kimmking.gateway.router.HttpEndpointRouterImp;
...
public class HttpClientOutboundHandler {
    ...
    public void handle(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx) {
        ...
        String backendUrl = new HttpEndpointRouterImp().route(this.proxyServerList);
